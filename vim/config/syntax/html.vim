...
" new html 5.0 tags
syn keyword htmlTagName contained article section header footer aside nav hgroup
syn keyword htmlTagName contained details summary
syn keyword htmlTagName contained command datelist keygen progress output
syn keyword htmlTagName contained audio video canvas source embed
syn keyword htmlTagName contained ruby rp rt
syn keyword htmlTagName contained time meter mark wbr
